...
const DEPARTMENTS = [
  ...
  { id: 'tech', name: 'Tech & Code generation', icon: '🛡️ ', desc: 'Code reviews, deployments, and security.' },
                        ...
                        {showTechModePicker && (
                          <div className="mt-8 p-6 rounded-2xl bg-white/[0.03] border border-green/30 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex items-center gap-3 mb-6">
                              ...
                              <div>
                                <h4 className="font-syne font-bold text-white text-[15px]">Tech Department: Code Generation Mode</h4>
