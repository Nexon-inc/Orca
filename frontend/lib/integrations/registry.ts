...
export const INTEGRATION_REGISTRY: IntegrationConfig[] = [
  ...
  // --- ADDED MISSING INTEGRATIONS FOR COMPOSIO FLOW -------------------
  ...
  { name: 'Sentry', service_key: 'sentry', department_key: 'tech', auth_method: 'apikey',
    agents: ['Ghost'], plan_required: 'builder' },
  { name: 'AWS', service_key: 'aws', department_key: 'tech', auth_method: 'apikey',
    agents: ['Ghost'], plan_required: 'builder' },
  { name: 'Linear', service_key: 'linear', department_key: 'tech', auth_method: 'oauth',
    agents: ['Ghost'], plan_required: 'builder' },
  { name: 'MongoDB', service_key: 'mongodb', department_key: 'tech', auth_method: 'apikey',
    agents: ['Ghost'], plan_required: 'builder' },
  { name: 'Calendar', service_key: 'google_calendar', department_key: 'ops', auth_method: 'oauth',
    agents: ['Atlas', 'Ghost', 'Aria', 'Purity'], plan_required: 'builder' },
  { name: 'Jira', service_key: 'jira', department_key: 'ops', auth_method: 'oauth',
    agents: ['Atlas', 'Ghost', 'Aria', 'Purity'], plan_required: 'builder' },
  { name: 'QuickBooks', service_key: 'quickbooks', department_key: 'finance', auth_method: 'oauth',
    agents: ['Atlas'], plan_required: 'builder' },
