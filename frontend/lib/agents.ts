...
export const AGENT_ROSTER: Agent[] = [
  // MARKETING
  { id: 'aria', name: 'Aria', icon: '🎙️', role: 'Social Media Manager', dept: 'marketing', description: 'Plans, writes, and schedules social content across LinkedIn, X, Instagram. Tracks engagement and adjusts strategy.', prompts: ['Write 5 tweets', 'Draft LinkedIn post', 'Content calendar', 'Schedule posts', 'Analyse engagement'] },
  { id: 'jackie', name: 'Jackie', icon: '✍️', role: 'Content Writer', dept: 'marketing', description: 'Long-form blogs, email sequences, landing page copy, newsletters, and product descriptions.', prompts: ['Write blog post', 'Email sequence', 'Landing copy', 'Newsletter draft', 'Product description'] },
  { id: 'eric', name: 'Eric', icon: '📢', role: 'Ads Manager', dept: 'marketing', description: 'Writes ad copy, manages campaign briefs, runs A/B test ideas, analyses performance, allocates budget.', prompts: ['Ad copy', 'Performance analysis', 'A/B test ideas', 'Budget allocation', 'Targeting audit'] },
  ...
  { id: 'wren', name: 'Wren', icon: '⚙️', role: 'DevOps Agent', dept: 'tech', description: 'Manages deployments to staging/production, monitors build status, handles rollbacks, updates environment variables.', prompts: ['Deploy to staging', 'Check build', 'Rollback deploy', 'Update env vars', 'Monitor uptime'] },
